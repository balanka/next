...
class TableCell<T extends Row<T>> extends React.Component<TableProps<T>> {
  getRenderValue() {
    const dateLocale =
    ...
    if (this.props.columnDef.render) {
      ...
      if (this.props.value instanceof Date) {
        ...
        isoDateRegex.exec(this.props.value)
      ) {
  ...
  getEmptyValue(emptyValue: unknown) {
  ...
  getStyle = () => {
    const width = CommonValues.reducePercentsInCalc(
      String(this.props.columnDef.tableData.width),
